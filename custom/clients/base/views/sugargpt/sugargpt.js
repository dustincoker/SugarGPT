({
   ...
   extendsFrom: 'SidebarNavItemView',
    ...
    if (!$("link[href='https://code.jquery.com/ui/1.14.1/themes/base/jquery-ui.css']").length) {
        $('head').append('<link rel="stylesheet" href="https://code.jquery.com/ui/1.14.1/themes/base/jquery-ui.css" type="text/css" />');
    }
	...
	this.$popup.resizable({
    		...
    		start: function(event, ui) {
        		ui.element.find('iframe').css('pointer-events', 'none');
    		},
    		stop: function(event, ui) {
        		ui.element.find('iframe').css('pointer-events', '');
    		}
	});
